...
class EventTest extends TestCase
{
    ...
    public function reportQuery_returns_correct_data()
    {
        ...
        $projectA = Project::factory()->create(['user_id' => $this->user->id, 'name' => 'Project A']);
        $projectB = Project::factory()->create(['user_id' => $this->user->id, 'name' => 'Project B']);

        $taskOne = Task::factory()->create(['user_id' => $this->user->id, 'name' => 'Task 1']);
        $taskTwo = Task::factory()->create(['user_id' => $this->user->id, 'name' => 'Task 2']);
        ...
        $events[] = Event::factory()->create(['user_id' => $this->user->id, 'project_id' => $projectA->id, 'task_id' => $taskOne->id, 'time_start' => '08:00', 'time_end' => '09:00', 'event_date' => '1900-01-01']);
        $events[] = Event::factory()->create(['user_id' => $this->user->id, 'project_id' => $projectA->id, 'task_id' => $taskTwo->id, 'time_start' => '09:00', 'time_end' => '10:30', 'event_date' => '1900-01-02']);
        ...
        $events[] = Event::factory()->create(['user_id' => $this->user->id, 'project_id' => $projectA->id, 'task_id' => $taskOne->id, 'time_start' => '08:00', 'time_end' => '09:00', 'event_date' => '1996-01-01']);
        $events[] = Event::factory()->create(['user_id' => $this->user->id, 'project_id' => $projectA->id, 'task_id' => $taskTwo->id, 'time_start' => '10:00', 'time_end' => '11:30', 'event_date' => '1996-01-02']);

        $events[] = Event::factory()->create(['user_id' => $this->user->id, 'project_id' => $projectB->id, 'task_id' => $taskOne->id, 'time_start' => '08:00', 'time_end' => '09:00', 'event_date' => '1996-01-03']);
        $events[] = Event::factory()->create(['user_id' => $this->user->id, 'project_id' => $projectB->id, 'task_id' => $taskTwo->id, 'time_start' => '10:00', 'time_end' => '11:15', 'event_date' => '1996-01-04']);
        ...
        // dd($results->where('project', 'Project A')->sum('duration'));
     ...
     *  
     * */
    public function totalTaskTimeBetweenTwoDates_returns_correct_data()
    {
    }
}
